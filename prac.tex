...
>>>>>>> 748efbbcfa7f2e6fd39d1329530d5351430b0246
\newpage
...
\item Since the raspberry pi camera is not permanently fixed to the system, a slight movement alters the calibration data of the system
\end{enumerate}

\subsection{Enhancements}
\begin{enumerate}
\item A proper hardware setup with the raspberry pi system fixed inside LOOMA software can prevent the system from being calibrated each time it is moved during use
...
\item The system performs single clicks and drag as required inside LOOMA software, but with further enhancements, the algorithm can be altered to perform double clicks as well
\end{enumerate}
\newpage
