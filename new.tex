...
\begin{thebibliography}{}
	...
	\bibitem{mik} Mikawa, M., Morimoto, Y., Tanaka, K.: Guidance method using laser pointer and gestures for librarian robot, IEEE-RO-MAN, September, 2010

	\bibitem{joh} Johnny Chung Lee, Hacking the Nintendo Wii Remote, Carnegie 		   Mellon University, IEEE-CS,2008 

	\bibitem{kent} Kent L. Norman, Kirk D. Norman, University of Maryland,      Comparison of Relative Versus Absolute Pointing Device2, May, 2010

	\bibitem{mat} Matej MESKO, Stefan TOTH, Laser Spot Detection, University of Zilina, Faculty of Management Science and Informatics (2013) 
