...
\begin{tikzpicture}[node distance = 4cm, auto]
    ...
    \node [block, right of=Set, node distance=4.5cm] (Acquire) {Laser Point};
...
\caption {\texttt{Hardware and Electrical parts of Looma system}}
\end{figure}
...
The communication between raspberry pi and the computer system is done via TCP protocol. 
...
\end{tikzpicture}
\caption{This text looks very small}
\end{figure}
